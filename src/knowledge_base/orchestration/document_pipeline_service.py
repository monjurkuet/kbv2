...
from knowledge_base.ingestion.v1.embedding_client import EmbeddingClient, EmbeddingConfig
...
class DocumentPipelineService(BaseService):
    ...
    async def partition(
        ...
        self._logger.info(f"Partitioned document '{doc_name}' into {len(document.chunks)} chunks")
        return document
